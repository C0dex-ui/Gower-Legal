...
name: ui-ux-pro-max
description: >
  Filtered design consult for this homepage generator. Use at DESIGN.md time
  for style name, font pairing, landing-pattern name, and UX checks only.
  MUST Read HOUSE.md first. Discard catalog palettes, JS stacks, charts, and
  GSAP. Colors stay from logo.png. Triggers: homepage-generator step 2,
  DESIGN.md, type pairing, UI style, uniqueness style name.
---
# ui-ux-pro-max

**This repo:** Read [HOUSE.md](HOUSE.md) first. Allowlist only. Do not apply catalog colors, Tailwind/React/Three.js, charts, or GSAP.
